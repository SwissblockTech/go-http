...
import (
	...
	"github.com/swisslockTech/go-http/http-client/config"
	"github.com/swisslockTech/go-http/http-client/logging"
	"github.com/swisslockTech/go-http/http-client/monitoring"
	"github.com/swisslockTech/go-http/http-client/rest"
	"github.com/swisslockTech/go-http/http-client/tracing"
)
